...
/* Data has key "county" and value "rental" - i.e. average rental price per county */
     queueMicrotask()
    .defer(d3.csv, "../imgs/rentals-2015-bycounty.csv", data)
    .await(ready);
...
function ready(error, data) {
  ...
  d3.xml("..imgs/bahia.svg", "image/svg+xml", function(error, xml) {		/* embed the SVG map */
    if (error) throw error;
